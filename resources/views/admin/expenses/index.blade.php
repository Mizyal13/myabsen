                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body text-center">
                                                    @php
                                                        $receiptPath = 'receipts/'.$expenses->get($i-1)->receipt;
                                                        $receiptUrl = Storage::disk('public')->exists($receiptPath)
                                                            ? Storage::url($receiptPath)
                                                            : null;
                                                    @endphp
                                                    @if ($receiptUrl)
                                                        <img src="{{ $receiptUrl }}" class="img-fluid" alt="Receipt Image" style="width: auto; height:100%">
                                                    @else
                                                        <p class="text-muted mb-0">Berkas bukti tidak ditemukan.</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
