                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($employee->attendanceToday)
                                        ...
                                        <td>
                                            Terekam sejak {{ Carbon\Carbon::parse($employee->attendanceToday->created_at)->format('H:i:s') }} dari {{ $employee->attendanceToday->entry_location }}
                                            @if ($employee->attendanceToday->entry_photo)
                                                <div class="mt-2">
                                                    <span class="d-block text-muted mb-1">Foto Masuk:</span>
                                                    <img src="{{ asset('storage/'.$employee->attendanceToday->entry_photo) }}" alt="Foto Masuk" class="img-fluid rounded" style="max-height: 110px;">
                                                </div>
                                            @endif
                                        </td>
                                        ...
                                        @if(!empty($employee->attendanceToday->exit_location))
                                            <td>
                                                Terekam sejak {{ Carbon\Carbon::parse($employee->attendanceToday->updated_at)->format('H:i:s') }} dari {{ $employee->attendanceToday->exit_location }}
                                                @if ($employee->attendanceToday->exit_photo)
                                                    <div class="mt-2">
                                                        <span class="d-block text-muted mb-1">Foto Pulang:</span>
                                                        <img src="{{ asset('storage/'.$employee->attendanceToday->exit_photo) }}" alt="Foto Pulang" class="img-fluid rounded" style="max-height: 110px;">
                                                    </div>
                                                @endif
                                            </td>
                                        @else
