                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $employeePhotoPath = $employeePhoto ? 'employee_photos/'.$employeePhoto : null;
                            $employeePhotoUrl = ($employeePhotoPath && Storage::disk('public')->exists($employeePhotoPath))
                                ? Storage::url($employeePhotoPath)
                                : asset('img/partner.png');
                        @endphp
                        <div class="row mb-3">
                            <div class="col text-center mx-auto">
                                <img src="{{ $employeePhotoUrl }}" class="rounded-circle img-fluid" alt="Foto Profil"
